    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, seqlens: Tensor, ws_short: int, ws_long: int, enable_tread: bool):
        ...
        for i in range(1,len(self.blocks)):
            attn_args = AttnArgs(
                ...
                seqlens=seqlens,
                bm_size=bm_sizes[i] if enable_tread and bm_sizes[i] and tread_start_layer < i <= tread_end_layer else bm_sizes[i] * 2,
                cos=self.yarn.cos,
                sin=self.yarn.sin,
...
class Hyperparameters:
    ...
    # optimization
    num_scheduled_iterations: int = 2335  # number of steps to complete lr and ws schedule
    num_extension_iterations: int = 80  # number of steps to continue training at final lr and ws
