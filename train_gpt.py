...
def cautious_wd_and_update_inplace(p, mantissa, grad, wd_tensor, lr_tensor):
    ...
    update_wd = grad + p_precise * wd_factor 

    update = torch.where(grad * update_wd > 0 , update_wd, grad)
    p_precise.copy_(p_precise - update * lr_factor)
...
class TrainingManager():
    ...
    def __init__(self, model):
        ...
        self.muon_opt = NorMuon(muon_params, lr=0.023, momentum=0.95, beta2=0.95, weight_decay=0.4)
