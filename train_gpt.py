...
class Router:
    ...
    def random_half_per_sequence(self, x, seqlens: torch.Tensor, *, generator=None):
        ...
        #                          new_seqlens,
        #                          tail])
        new_seqlens = seqlens.clone().detach()
    ...
    def end_route(self, masked_x, ids_keep, original_x):
        ...
        x_unmasked = original_x.scatter( 1, ids_keep[None, :, None].expand(1,masked_x.size(1), original_x.size(2)), masked_x)
        return x_unmasked
...
class Hyperparameters:
    ...
    # optimization
    num_scheduled_iterations: int = 2500#2275  # number of steps to complete lr and ws schedule
